...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14">
            ...
            <div className="flex items-center gap-1">
              <Link
                href="/sign-in"
                className="text-sm font-medium text-slate-600 hover:text-slate-900 px-3 py-1.5 rounded-md hover:bg-slate-50 transition-all"
              >
                Sign in
              </Link>
              <Link
                ...
                className="bg-cyan-600 text-white text-sm font-medium px-4 py-1.5 rounded-md hover:bg-cyan-700 transition-all active:scale-[0.98]"
              >
                Get started
              </Link>
            </div>
      ...
      <section className="relative">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20 md:pt-32 md:pb-28">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-1.5 bg-slate-100 text-slate-600 text-xs font-medium px-2.5 py-1 rounded-full mb-6">
            ...
            <div className="flex items-center gap-3 mt-8">
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-cyan-600 text-white px-5 py-2.5 rounded-lg text-sm font-medium hover:bg-cyan-700 transition-all active:scale-[0.98]"
              >
                Book a demo
              </Link>
              <Link
                href="/sign-in"
                className="border border-slate-200 text-slate-700 px-5 py-2.5 rounded-lg text-sm font-medium hover:bg-slate-50 transition-all active:scale-[0.98]"
              >
                Sign in
              </Link>
            </div>
              ...
              <div className="relative bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-sm font-medium text-slate-900">CBC Report Cards</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <Link
                key={portal.title}
                href={portal.href}
                className="group block border border-slate-200 rounded-xl p-5 hover:border-slate-300 hover:shadow-sm transition-all"
              >
                ...
                <h3 className="text-sm font-semibold text-slate-900">{portal.title}</h3>
                <p className="text-xs text-slate-500 mt-1 leading-relaxed">{portal.desc}</p>
              </Link>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-cyan-600 rounded-2xl p-10 md:p-14 text-center">
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-white text-slate-900 px-6 py-3 rounded-lg text-sm font-medium hover:bg-slate-100 transition-all active:scale-[0.98] mt-8"
            >
              Book a demo
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-semibold text-slate-900">Skuli</span>
            </div>
            <div className="flex items-center gap-6 text-xs text-slate-500">
              <a href="mailto:info@skuli.co.ke" className="hover:text-slate-900 transition-colors">info@skuli.co.ke</a>
