...
const FEATURES = [
  {
    ...
    description: "Standards-based progress reports with 8-point rubric levels for every student across all 7 core competencies.",
    icon: (
  ...
  },
  {
    ...
    description: "Teachers create and distribute assignments. Students submit work digitally. Track pending and completed work.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description: "Digital library with ebooks, class reading lists, and book availability tracking.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25" />
      </svg>
  ...
  {
    title: "Timetable",
    description: "Weekly class schedules visible to teachers, students, and parents. Real-time updates.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description: "Daily attendance marking for students and staff. Parents see attendance records in real-time.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description: "Teachers post announcements, trips, and events. Students and parents receive updates instantly.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      <section className="bg-gradient-to-b from-slate-50 to-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-blue-50 text-blue-700 text-xs font-medium px-3 py-1 rounded-full mb-6 border border-blue-100">
            ...
            <p className="text-lg text-slate-600 mb-8 max-w-2xl mx-auto leading-relaxed">
              One platform for teachers, students, and parents. CBC report cards,
              assignments, attendance, library, and announcements — all in one place.
            </p>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 max-w-xl mx-auto">
              Purpose-built for the Kenyan CBC curriculum. No generic school software.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-slate-900 rounded-2xl p-10 md:p-14 text-center">
            ...
            <p className="text-slate-300 max-w-xl mx-auto mb-8">
              Book a free onboarding call with our team. We will set up your school,
              import your data, and get you running in under 24 hours.
            </p>
            <a
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-sm text-slate-500">
              &copy; {new Date().getFullYear()} Skuli. Smart ERP for Kenyan CBC Schools.
            </p>
          </div>
        </div>
      </footer>
